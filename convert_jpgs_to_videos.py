"""Convert JPG image sequences into MP4 videos at 5 FPS.

Usage:
    python convert_jpgs_to_videos.py --source 01.데이터/your_images --output outputs/jpg_videos --num-videos 5 --fps 5

The script groups all JPG/JPEG/PNG files in the source folder into roughly
`num_videos` MP4 files. Each resulting video is written at the requested FPS.
"""
